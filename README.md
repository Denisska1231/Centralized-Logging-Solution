...
ต้องติดตั้ง **Grafana** **Loki** **Promtail** ให้ครบทั้ง 3 ตัว จึงจะใช้งานได้<br>
แนะนำให้ติดตั้งทั้ง 3 ตัว ภายในเครื่องเดียวกัน เพื่อความง่ายและสะดวกในการใช้งาน<br>
เข้าหน้า Grafana ได้ที่ http://localhost:3000/ (แนะนำเข้าด้วย Firefox)
...
### รวมไฟล์มากกว่า 1 ใน Group By
1. เลือก Add Transformation หลังจากนั้นหา คำที่มี Merge series/table *ต้องอยู่อันดับ Transformation ที่1หรือ2* เพื่อให้ตัวคัดกรองของ Transformation อื่นๆทำงานได้แบบไม่เกิดบัค
<br>![Description](/Picture/image011.png)
### Table
<br>![Description](/Picture/image013.png)
1. เลือก Visualizations เป็น Table โดยตัวเลือกที่ใช้จะเป็น  

-  Table 

หัวข้อ Show table header ให้เปิดเพื่อดูว่า ข้อมูลนี้มาจาก Table อะไร 

หัวข้อ Cell height มีเพื่อต้องการให้ cell มีขนาดเท่าไหร่ 

หัวข้อ Enable pagination ถ้าเลือกปิด จะเป็นเลื่อนลงเรี่อยๆ ถ้าเปิดจะเป็นแบบ Page 1 2 3...  

หัวข้อ  column ทั้ง3 มีไว้เพิ่มกำหนดขนาดและจุดตัวอักษณว่าวางตรงไหน 

หัวข้อ Column filter มีไว้เพื่อ Filter ข้อความที่เรากำหนดไว้
<br>![Description](/Picture/image015.png)
### Stat
![Description](/Picture/image017.png)
เลือก Visuallzations เป็น Stat โดยตัวเลือกที่ใช้จะเป็น  

-  Value options จะมี  

หัวข้อ  Show ที่ต้องเลือก All values 

หัวข้อ Numeric Fields เนื่องจากตัวที่กรองเราอยู่ในนั้น 
<br>![Description](/Picture/image019.png)
- Stat styles  

หัวข้อ Orirentation จะใช้ Verticalเพื่อเรียงจากซ้้ายไปขวา จะใช้ Horizontal ก็ได้ถ้าต้องการแบบเรียงจากบนลงล่าง  

หัวข้อ Color mode มี4แบบ none(ขาวดำ) value (มีสี)ี Background Gradient(มีสีพื้นหลัง) Background Solid (สีพื้นหลังเข้มขึ้น)  

หัวข้อ Text alignment มี Auto ที่จะทำหน้าที่จัดตัวหนังสือให้ ส่วนมากจะชิดซ้าย , Center จัดตรงกลาง  
...
หัวข้อ Show  เลือก All values 

หัวข้อ Fields เลือก Numeric Fields เนื่องจากตัวที่กรองเราอยู่ในนั้น  
<br>![Description](/Picture/image025.png)
- Pie chart  

หัวข้อ Piechart type มี2แบบ Pie(วงกลม) Donut(ว่างตรงกลางแบบโดนัท) 

หัวข้อ Lables Percent หรือ  Name ก็ได้ 
<br>![Description](/Picture/image027.png)
